...
//
//import gshp.net.grisi.dto.DtoEARespuesta;
//
///**
...
//        super("EARespuesta", "ida", "idReporteLocal");
...
//    }
//
//    public int deleteByIdReport(int idReporte) {
//        db = helper.getWritableDatabase();
//        int resp = db
//                .delete(TABLE_NAME, REPORT_FIELD + "=" + idReporte, null);
//        db.close();
//        return resp;
//    }
//
...
//                "				FROM\n" +
//                "				EARespuesta\n" +
//                "				INNER JOIN report ON report.id = EARespuesta.idReporteLocal AND report.id_report_server > 0 AND report.active=1\n" +
...
//        Log.e("update", "table "+TABLE_NAME+ " idreportLocal "+idReporteLocal);
//        db = helper.getWritableDatabase();
//        try {
...
//
//    /**
//     * El id encuesta debe ser menor a 100
//     * ya que las mayores son especiales (small format)
//     */
//    public boolean existsByIdReport(int idReport) {
//        db=helper.getReadableDatabase();
//        cursor=db.rawQuery("SELECT *"
//                + "FROM "+TABLE_NAME
//                + " WHERE idEncuesta<100 and "+REPORT_FIELD+"="+idReport,null);
//
